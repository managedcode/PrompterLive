...
function navigateTo(screenId) {
    ...
    // Reset reader to card 0, word 0 when entering teleprompter
    if (screenId === 'teleprompter') {
        resetReader();
    }
    // Update global header per screen
...
function updateAppHeader(screenId) {
    ...
    switch (screenId) {
        ...
        case 'rsvp':
            ...
            right.innerHTML = `<span class="top-bar-title" style="font-size:13px">300 WPM</span>`;
            break;
        case 'teleprompter':
