...
public static partial class UiTestIds
{
    public static class Editor
    {
        ...
        public const string GraphAnalyze = "editor-graph-analyze";
        public const string GraphAutoLayout = "editor-graph-auto-layout";
        ...
        public const string GraphRailLayoutMode = "editor-graph-rail-layout-mode";
        public const string GraphRailNodeStyleMode = "editor-graph-rail-node-style-mode";
        public const string GraphRailPanel = "editor-graph-rail-panel";
        public const string GraphRailTab = "editor-graph-rail-tab";
        public const string GraphOnlyToggle = "editor-graph-only-toggle";
        public const string GraphStoryLayoutMode = "editor-graph-story-layout-mode";
        public const string GraphSourcePane = "editor-graph-source-pane";
        public const string GraphSplit = "editor-graph-split";
        public const string GraphSplitResizer = "editor-graph-split-resizer";
        public const string GraphSummary = "editor-graph-summary";
        public const string GraphSemanticStatus = "editor-graph-semantic-status";
        public const string GraphTab = "editor-graph-tab";
        public const string GraphTokenizerAnalyze = "editor-graph-tokenizer-analyze";
