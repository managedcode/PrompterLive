...
internal static class AppShellFilePickerInteropMethodNames
{
    public const string FileSaveModeCancelled = "cancelled";
    public const string FileSaveModeDownload = "download";
    public const string FileSaveModeFileSystem = "file-system";
