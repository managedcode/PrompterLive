...
- The editor must support multiple authoring views: canonical TPS source, a simple writing-focused editor, and a rendered visual/storyboard view that hides raw Markdown/TPS syntax while preserving styled structure for non-technical authors.
